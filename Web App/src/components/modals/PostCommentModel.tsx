	...
	return (
		<>
			<Modal
				...
				onClose={() => {
					onClose(false)
					_dispatch(setCommentOpen(false))
				}}
				center
				closeIcon={closeIcon}
				classNames={{
				...
				<ModalWrapper>
					<Head direction="row" align="center" justify="space-between"></Head>
					<Body>
						{sellersCardOpen ? <SellersCard commentsModal={true} data={sellersData} sellersCardOpen={sellersCardOpen} sellerCard={true} /> : <ProductPost commentsModal={true} setUserId={setUserId} data={data} userData={userData} />}
					</Body>
				</ModalWrapper>
			</Modal>
		</>
...
const Head = styled(Flexed)`
	...
	// ${media.xs`padding:1rem 1.5rem 1.5rem 1.5rem;`};
`
