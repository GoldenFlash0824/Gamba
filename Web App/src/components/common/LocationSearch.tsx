...
const LocationSearch = ({ setLocation, isPrivate, setLatitude, location, setLongitude, setLocationError, isProfile }: any) => {
	...
	function removeCountryFromAddress(addressDetails) {
		const filteredAddressComponents = addressDetails.address_components.filter((component) => !component.types.includes('country'))
