...
import EventJoinersCard from '../EventJoinersCard'
const closeIcon = (
...
const JoinEventModal = ({onClose, data, setUserId}: any) => {
				...
				<ModalWrapper>
					...
					<Body>
						{data.map((event) => (
							...
							// 			}}>
							// 			<ImgWrapper src={`https://imagescontent.s3.us-east-1.amazonaws.com/${event.joinEventUser.image}`} />
							// 		</div>
							...
							// 		</Text>
							// 	</Flexed>
							// 	<JoinButton> Chat </JoinButton>
							// </StyledFlex>
							<EventJoinersCard event={event} setUserId={setUserId} />
						))}
