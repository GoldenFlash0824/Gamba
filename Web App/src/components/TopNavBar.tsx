...
import {saveSearchText, setUserId} from '../actions/authActions'
		...
		<>
			<Wrapper fluid className='shadow-sm'>
				...
				<CustomRow className='d-flex justify-content-between align-items-center'>
					<Col xxl={2.5} xl={3} lg={3} md={3} sm={3} xs={3}>
					...
					<MiddleLayout xxl={6} xl={6} lg={4} lgOrder={2} smOrder={3} xsOrder={3}>
						<SubNavBar />
					</MiddleLayout>
					<Col xxl={2.5} xl={3} lg={3} md={9} sm={9} xs={9} lgOrder={3} smOrder={2} xsOrder={2}>
						{authToken === null && (
