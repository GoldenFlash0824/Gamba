...
const LoginConfirmationPopupModel = ({onClose, onSuccess, isDelete}: any) => {
	...
	const checkValidationOnClick = () => {
		...
		if (user?.email != email) {
			setEmailError('provided Email not matched with your login details')
			isValid = false
		}
							...
							{registrationCode ? (
								...
								<Wrapper>
									...
									<Flexed justify="center">
										<Heading level={5} fontWeight={600} isCentered color="dark_black">
											{isDelete ? 'Confirm your login information to delete your account' : 'Confirm your login information to temporarily disable your account.'}
										</Heading>
...
export default LoginConfirmationPopupModel
