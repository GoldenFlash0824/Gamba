...
import { Grid, makeStyles, Typography, Avatar, Button, AppBar, Tabs, Tab, Box, useTheme } from '@material-ui/core'
...
const ViewAllPaidOrder = forwardRef((props, ref) => {
	...
	const [orderReports, setOrderReports] = useState({
		columns: [
			...
			// {label: 'Full Name', field: 'name', width: 270},
			...
			// { label: 'Reports', field: 'bookingOrder', width: 270 },
						...
						<div className={classes.header}>
							...
							<div className='d-flex justify-content-between align-items-center gap-5 '>
								...
								<div style={{ display: 'flex', justifyContent: 'flex-end', margin: '0.5rem 0.5rem 0 0.5rem' , fontSize: '1rem',  }}>
									...
									<Button  color="secondary" style={{ fontSize: '1rem' , height: '32px' , backgroundColor: 'transparent' , color: '#333' , border: '1px solid #333'}} className={classes.saveButton} onClick={() => exportToCSV()}>
