...
const ViewAllManageOrder = forwardRef((props, ref) => {
	...
	const [users, setUsers] = useState({
		columns: [
			...
			{ label: 'Name', field: 'delivery_info', width: 270 },
			{ label: 'User Image', field: 'order_by', width: 200, sort: String('disabled') },
			{ label: 'Charge', field: 'order_from', width: 200, sort: String('disabled') }
		],
		rows: [
		]
	})
	...
	const createManageOrderTable = (row) => {
		// let _obj = {
		// 	userId: row.id,
		// 	phone: row.phone,
		// 	full_name: (
						...
						<div className={classes.root1}>
							<AppBar position="static" color="default">
								<Tabs value={value} onChange={handleChange} indicatorColor="primary" textColor="primary" variant="fullWidth">
									...
									<Tab className={classes.tabHeading} label="Paid" icon={<HowToReg className={classes.tabIcon} />} />
									<Tab className={classes.tabHeading} label="Dispute" icon={<HowToReg className={classes.tabIcon} />} />
									{/* <Tab className={classes.tabHeading} label="Dispute" icon={<HowToReg className={classes.tabIcon} />} /> */}
								</Tabs>
							</AppBar>
...
export default ViewAllManageOrder
