...
const ViewAllProductSold = forwardRef((props, ref) => {
	...
	const [users, setUsers] = useState({
		columns: [
			...
			{ label: 'Order Date', field: 'order_date', width: 270 },
			{ label: 'Date Of Delivery', field: 'date_of_delivery', width: 270 },
			...
			{ label: '% To Gamba', field: 'gamba_share', width: 200, sort: String('disabled') },
		...
		rows: [
			{
				...
				date_of_delivery: '26/4/2023',
				seller: 'San Manheim',
				sold_to: 'Rona Samsian',
				Order_no: '06335',
				total_order: '35.16',
				gamba_share: '15%',
				fees_dues: '5.27',
	...
	const createProductSoldTable = (row) => {
		// let _obj = {
		// 	userId: row.id,
		// 	phone: row.phone,
		// 	full_name: (
						...
						<div className={classes.root1}>
							<AppBar position="static" color="default">
								<Tabs value={value} onChange={handleChange} indicatorColor="primary" textColor="primary" variant="fullWidth">
									...
									<Tab className={classes.tabHeading} label="Product Sold" icon={<HowToReg className={classes.tabIcon} />} />
...
export default ViewAllProductSold
