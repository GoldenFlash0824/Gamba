	...
	return (
		<>
			<CardWrapper
				...
				<CardBody direction={'column'} justify={'space-between'}>
					<Flexed direction={'column'}>
						...
						{!myProducts && (
							<Flexed className="" margin="0.6rem 0rem 0rem 0rem" direction={'row'} align={'center'} justify={'space-between'} gap={0.25}>
								<TextBelowUser
									onClick={() => {
										setIsProductDetailsModalOpen(true)
									}}
					...
					{userId !== content?.u_id && (
						<Flexed direction="row" justify="flex-end" margin={'0.8rem 0rem 0rem 0rem'}>
							<ConnectButton
								onClick={() => {
									if (isUserLogIn !== null) {
										setIsProductDetailsModalOpen(true)
