		...
		<>
			<Modal
				...
				<ModalWrapper>
					...
					<Body>
						It seems that seller accepts only cash. Please <NavigateToSeller onClick={() => data?.user?.chat_id && router.navigate(`/chat/${data?.user?.chat_id}`)}>contact seller</NavigateToSeller> for further information.
					</Body>
				</ModalWrapper>
			</Modal>
		</>
...
const NavigateToSeller = styled.span`
	cursor: pointer;
